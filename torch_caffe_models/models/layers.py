"""some additional layers not present in PyTorch"""

# LRN <https://github.com/pytorch/pytorch/issues/653#issuecomment-304361386>
...
class SpatialCrossMapLRNFunc(Function):
    def __init__(self, size, alpha=1e-4, beta=0.75, k=1):
        super(SpatialCrossMapLRNFunc, self).__init__()
        self.size = size
        self.alpha = alpha
        self.beta = beta
        self.k = k
